...
Function CreatePosterItem(id as string, desc1 as string, desc2 as string, abbr as string) as Object
    item = CreateObject("roAssociativeArray")
    item.ShortDescriptionLine1 = desc1
    item.ShortDescriptionLine2 = desc2
    item.HDPosterUrl = "pkg:/images/posters/cu-" + abbr + "-hd.png"
    item.SDPosterUrl = "pkg:/images/posters/cu-" + abbr + "-sd.png"
    return item
end Function
